...
export const useSocket = (): {
    ...
    getSocketId: () => string,
    enableChannelWhiteList: boolean, setEnableChannelWhiteList: Dispatch<SetStateAction<boolean>>,
    channelInfo: {
        [channel_name: string]: ChannelInfo;
    },
    userCounter: number | undefined, sendChatMessage: (channel_name: string, message: string) => Promise<void>; joinRoom: (
        channel_name: string) => Promise<void>, disconnectSocket: () => void,
    leaveRoom: (e: any, channel_name: string) => Promise<void>,
    channelsRef: MutableRefObject<Channel[]>, socketConnected: boolean, selectedChannel: number | undefined
} => {
    ...
    return {
        ...
        selectChannel, setEnableChannelWhiteList, channelInfo, userCounter, sendChatMessage, joinRoom, disconnectSocket, socketConnected, leaveRoom, selectedChannel
    }
}
