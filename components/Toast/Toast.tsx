        ...
        <>
            {
                ...
                <div className="frameHeader toast">
                    <div className="toast-body">
                        ...
                        {type === 'failure' &&
                            <img src='https://gateway.pinata.cloud/ipfs/QmR3abnQmUWuS3tUWSdKMs7uSnjVtGTGSjxgYK3GgLgEgf/triangle-exclamation-solid.svg' className='failure exclamation-triangle' />
                        }
                    </div>
