...
export const ChatOptions: React.FunctionComponent<ChatOptionsProps> = ({ dateHidden, setDateHidden, timeHidden, setTimeHidden, shortenSocketId, setShortenSocketId, enableChannelWhiteListRef, setEnableChannelWhiteListState, separateChatAndChannels, setSeparateChatAndChannels }) => {
    ...
    return (
        <Frame className="chat-options" body={chatOptionsBody} headerText="OPTIONS" />
    )
}