  ...
  return (
    <>
      <ul>
        ...
        <li>
          All fees collected by smart contracts operated by the Immutable
          Organization will be distributed proportionally to all token holders.
        </li>
      </ul>
