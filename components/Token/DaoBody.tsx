			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>
							The remaining 20% will be under the control of the Organization until further progress has been made for phase 1.0. It will be
							decided if this remaining amount will be burned or unlocked.
						</li>
					</ul>
				</li>
