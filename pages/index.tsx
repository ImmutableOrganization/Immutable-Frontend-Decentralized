            ...
            <Frame
              ...
              body={() => (
                <div className='new-post'>
                  ...
                  <h3>
                    Post contract:{' '}
                    <a target='_blank' href={contracts.PostContract.blockExplorer}>
                      {contracts.PostContract.address}.
                    </a>
                  </h3>
                </div>
              )}
              ...
              body={() => (
                <div className='new-post'>
                  <input
                    ...
                    value={postToViewId}
                    onChange={(e) => setPostToViewId(e.target.value)}
                  />
                    ...
                    <Frame
                      ...
                      body={() => (
                        <div className='new-post'>
                          ...
                          />
                          <textarea placeholder='body...' className='text_input terminal-input' rows={10} onChange={(e) => setBody(e.target.value)}>
                            {body}
                          </textarea>
