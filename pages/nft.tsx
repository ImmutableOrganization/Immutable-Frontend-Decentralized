  ...
  return (
    <>
      <ul>
        ...
        <li>
          Divisibility factors: [1, 2, 3, 5, 7, 11, 13, 17]. 30% chance for first 3 numbers, 30% chance for middle 3 numbers, 30% chance for last 3 numbers, 10%
          probability for all numbers.{' '}
        </li>
